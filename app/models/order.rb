class Order < ActiveRecord::Base
  ...
  attr_accessible :notes, :ordered_at, :paid_for_by, :reimbursed, :shipping_cost, :receipt_name, :status, :tax_cost, :vendor_name, :project, :project_id, :order_items_attributes
